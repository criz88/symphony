defmodule SymphonyElixir.TestSupport do
  ...
  defmacro __using__(_opts) do
    quote do
      ...
      setup do
        ...
        logs_root = Path.join(workflow_root, "logs")
  ...
  defp workflow_content(overrides) do
    ...
    in_review_grace_shutdown_ms = Keyword.get(config, :in_review_grace_shutdown_ms)
    ...
    sections =
      [
        ...
        "  in_review_grace_shutdown_ms: #{yaml_value(in_review_grace_shutdown_ms)}",
        "codex:",
