```text
╭─ SYMPHONY STATUS
│ Sessions: 2/10 | Agents: 2 | Monitors: 0
...
│   ───────────────────────────────────────────────────────────────────────────────────────────────────────────────
│ ● MT-101   agent    running        4242     13m 5s / 11     120,450 thre...567890  turn completed (completed)
│ ● MT-102   agent    running        5252     6m 52s / 4       89,200 thre...567890  mix test --cover
│
├─ Backoff queue
│
│  No queued retries
